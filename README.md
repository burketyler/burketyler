...
### ⚙️ [bigsby](https://github.com/burketyler/bigsby)
...
### 🌐 [cf-functions](https://github.com/burketyler/cf-functions)
...
### 🧩 [ts-injection](https://github.com/burketyler/ts-injection)
...
**Frontend**
React, Next.js, Storybook, Material UI

**Backend**
Node.js, Fastify, LoopBack, GraphQL, REST

**Cloud & Infra**
AWS (Lambda, SQS, DynamoDB, API Gateway, CloudFront), Terraform

**Tooling**
CI/CD (GitHub Actions, GitLab), Jest, ESLint, Lerna, OpenAPI
